...
//{
    ...
    //Weather weather;
    //private bool competitorIsOut = false;
...
//        {
//            descriptionTexts[1].text = "COMPETITOR TAKES RISK... OH NO... OUT!!!";
//            competitorIsOut = true;
//            return;
...
//        else
//        {
//            if (competition.partsOfRun < 3)
//            {
//                actualCompetitor.CalculateFinal(actualCompetitor.runModifier); // ADD EXTRA EVENTS POINTS
//                competition.showResults(actualCompetitor, actualCompetitor.finalPerformance);
//            }
//            else
//            {
//                competition.EndRun();
